...
# номиналы монеток из своей коллекции. Получилось два списка. Эти
# списки поступают на вход программы в виде двух строк из целых чисел,
# (числа записаны через пробел). Необходимо выделить значения,
# присутствующие только в одном списке и оставить среди них только
# нечетные. Результат вывести на экран.
...
def filter_lst1(num) -> list:
    ...
    if has_num == True and int(num) % 2 == 0:
        return num
